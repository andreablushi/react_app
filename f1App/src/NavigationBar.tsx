  ...
  const [darkMode, setDarkMode] = useState(cfg.darkMode);
    ...
    return (
      <SafeAreaView style={styles.navigationBar}>
        ...
        <TouchableOpacity onPress={() => navigation.replace('Drivers')} style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <View style={{flex: 1, paddingVertical: 14}}>
            <Image source={darkMode ? require('../img/icon/dark/drivers.png') : require('../img/icon/light/drivers.png')} style={styles.icon} />
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() =>{navigation.replace('Teams')}} style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <View style={{flex: 1, paddingVertical: 14}}>
